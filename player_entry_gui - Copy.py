...
class Player_Entry_GUI:
    def __init__(self) -> None:
        self.root = Tk()
        self.red_team:List[Tuple[StringVar, BooleanVar]] = []
        self.green_team:List[Tuple[StringVar, BooleanVar]] = []
        self.selected_player:int = -1
    ...
    def insert_player(self) -> None:
        ...
        if (self.selected_player % 2 == 0):
            ...
            #Add new player, move self.arrow forward
    ...
    def delete_player(self) -> None:
        ...
        if (self.selected_player % 2 == 0):
            ...
            #Delete player, move self.arrow back
            if (int(self.selected_player / 2) - 1 > -1):
                self.root.nametowidget(".player_entry.teams.green_team.green_" + str(int(self.selected_player / 2) - 1) + ".codename").focus()
